...
<meta name="description" content="AL Hadi Enterprise - Bangladesh's Store">
...
<div style=" margin-top: 30px; margin-bottom: 60px;">
  ...
  <img style="margin-right: 15px; width: 180px; z-index: 9998;" src="{{ asset($logo)}}"
       alt="">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12 ">
        <p class="hot-number"><i class="fa fa-phone"></i> Hotline: <a href="tel:+8801683262059">+88 01683-262059</a>,
          <a href="tel:+8801678448548">+88 01678-448548</a></p>
      </div>
  ...
  <div class="" style="background-color: white;">
    ...
    <div>
      <p class="hot-number hot-number-mobile" style="text-align: center;">
        <i class="fa fa-phone"></i> Hotline: <a href="tel:+8801683262059">+88 01683-262059</a>, <a
          href="tel:+8801678448548">+88 01678-448548</a>
      </p>
    </div>
...
<div class="ps-footer bg--cover" data-background="{{ asset('assets/frontend/images/background/parallax.jpg') }}">
  <div class="ps-footer__content" style="position: sticky">
    <img src="{{asset('assets/images/SSLCommerz.png')}}">
    <div class="ps-container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
            <aside class="ps-widget--footer ps-widget--info">
              ...
              <footer>
                <p><strong><i class="fa fa-map-marker"></i> 1/A-B, College Street, Mirpur Road,<br/> Dhaka-1205,
                    Bangladesh</strong></p>
                <p><i class="fa fa-envelope"></i> <a href='mailto:support@alhadienterprise.com'>support@alhadienterprise.com</a>
                </p>
                <p><i class="fa fa-phone"></i> <a href="tel:+8801900000000">+8801900000000</a>
                </p>
                <p><i class="fa fa-phone"></i> <a href="tel:000000">000000</a>
                </p>
              </footer>
            </aside>
          </div>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
            <aside class="ps-widget--footer ps-widget--info">
              <header>
                <h3 class="ps-widget__title">Stadium Branch</h3>
              </header>
              <footer>
                <p><strong><i class="fa fa-map-marker"></i> Shop-30,31,32, Volleyball Stadium,<br/> Dhaka-1000,
                    Bangladesh</strong></p>
                {{--<p><i class="fa fa-envelope"></i>  <a href='mailto:support@alhadienterprise.com'>support@alhadienterprise.com</a>--}}
                </p>
              </footer>
        ...
        <!--    <header>-->
        <!--      <h3 class="ps-widget__title">Bashundhara Branch</h3>-->
        <!--    </header>-->
        <!--    <footer>-->
        <!--      <p><strong> <i class="fa fa-map-marker"></i> Shop# 91-94, Block D, Level:6, Bashundhara City, Dhaka,-->
        <!--          Bangladesh</strong></p>-->
        <!--      {{--<p><i class="fa fa-envelope"></i>   <a href='mailto:support@alhadienterprise.com'>support@alhadienterprise.com</a></p>--}}-->
        <!--      {{--<p><i class="fa fa-phone"></i>    <a href="tel:+8801678448547">+88 01678-448547</a></p>--}}-->
        <!--      {{--<p><i class="fa fa-phone"></i>    <a href="tel:+8801819871211">+88 01819871211</a></p>--}}-->
        <!--    </footer>-->
        <!--  </aside>-->
        <!--</div>-->
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
          <aside class="ps-widget--footer ps-widget--info second">
            <header>
              <h3 class="ps-widget__title">Uttara Branch</h3>
            </header>
            <footer>
              <p><strong> <i class="fa fa-map-marker"></i> Shop-5, Level-7, Polwel Carnation Center, Section-8,
                  Uttara, Dhaka, Bangladesh</strong></p>
              {{--<p><i class="fa fa-envelope"></i>  <a href='mailto:support@alhadienterprise.com'>support@alhadienterprise.com</a></p>--}}
              {{--<p><i class="fa fa-phone"></i>    <a href="tel:+8801678448549">+88 01678448549</a> </p>--}}


              {{--<p><i class="fa fa-envelope"></i>   <a href='mailto:support@alhadienterprise.com'>support@alhadienterprise.com</a></p>--}}
              {{--<p><i class="fa fa-phone"></i>    <a href="tel:+8801678448546">+88 01678-448546</a></p>--}}
            </footer>
          </aside>
        </div>
    ...
    <div class="ps-container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
          <p>&copy; <a href="#">AL Hadi Enterprise</a>. All rights Resevered. Developed by <a
              href="http://www.finlite-it.com"> FinLite IT</a></p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
          <ul class="ps-social">
            <li><a href="https://www.facebook.com/alhadienterprise/" target="_blank"><i class="fa fa-facebook"></i></a></li>
