            ...
            <div class="col-12">
              <form action="{{ route('login') }}" method="post">
                ...
                <div class="form-group text-right">
                  <span class="h6 mr-10"><a href="{{ route('forgotPassword') }}">Forgot password?</a></span>
                  <button style="background-color: #8b75b3; color: white;" type="submit" class="btn btn-sm">Login</button>
                </div>
                <div class="form-group text-right">
                  <span class="h6 mr-10">Don't have an account? <a href="{{ route('registration') }}">Register</a></span>
                </div>
              </form>
            </div>
          </div>
