              ...
              <div class="content">
                ...
                @if($value->quantity > 0 && $value->price > 0)
                  <div class="content-details fadeIn-top" style="margin-top: -50px;">
                    <a class="btn btn-success add-to-cart" data-id="{{ $value->id }}"> <i
                        class="fa fa-shopping-cart"></i> Add To Cart</a>
                  </div>
                @endif
                <div class="content-details fadeIn-bottom">
                  <a class="btn btn-success" href="{{ route('product.details', $value->slug) }}"> <i
                      class="fa fa-tasks"></i> See Details</a>
                </div>
              </div>
            </div>
