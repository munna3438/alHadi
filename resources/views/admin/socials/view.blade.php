...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">View Socials</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.socials.add') }}" class="btn btn-outline-success btn-sm mb-2">Add new</a>
          </div>
              ...
              <tbody>
                ...
                @foreach($socials as $value)
                  <tr class="gradeX">
                    ...
                    <td width="30">
                      <div class="d-flex">
                        <a href="{{ route('admin.socials.edit', $value->id) }}" class="btn btn-outline-info btn-sm m-0 p-1 mr-1" style="min-width: 0px;">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4>Delete Socials</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <strong>Are you sure to delete this Social?</strong>
          </div>
  ...
  <script>
    $( document ).ready(function() {
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('admin.socials.delete') }}",
          method: "delete",
          dataType: "html",
          data: {id: pid},
