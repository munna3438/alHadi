...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Side Banners</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.sidebanner.add') }}" class="btn btn-outline-success btn-sm mb-2">Add new</a>
          </div>
              ...
              <tbody>
                ...
                @foreach($side_banners as $value)
                  <tr class="gradeX">
                    ...
                    <td width="30">
                      <a href="{{ route('admin.sidebanner.edit', $value->id) }}" class="btn btn-outline-info btn-sm m-0 p-1 mr-1" style="min-width: 0px;">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4>Delete Side Banner</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <strong>Are you sure to delete this Side Banner?</strong>
          </div>
  ...
  <script>
    $( document ).ready(function() {
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('admin.sidebanner.delete') }}",
          method: "delete",
          dataType: "html",
          data: {id: pid},
