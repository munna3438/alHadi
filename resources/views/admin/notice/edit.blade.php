        ...
        <div class="ms-panel-body">
          ...
          <form action="{{ route('admin.notice.edit', $notice->id ) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="notice_title" placeholder="Enter title" value="{{ $notice->title }}" required name="title" class="form-control @error('title') is-invalid @enderror">
              @error('title')
            ...
            <div class="form-group">
              ...
              <textarea id="summernote" name="description" required>{{ $notice->description }}</textarea>
              @error('description')
            ...
            <div class="form-group">
              <span>Status: </span>
              <label for="active" class="mr-3"><input id="active" type="radio" value="active" class="ml-3 mr-2" name="status" @if(strtolower($notice->status) == 'active') checked @endif>Active</label>
              <label for="inactive" class="mr-3"><input id="inactive" type="radio" value="inactive" class="ml-3 mr-2" name="status" @if(strtolower($notice->status) == 'inactive') checked @endif>Inactive</label>
            </div>
