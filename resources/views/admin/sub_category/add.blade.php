...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Add Sub Category</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6">
                  ...
                  <input type="text" id="sub_category_name" required value="{{old('name')}}" placeholder="Enter a sub-category name" name="name" class="form-control @error('name') is-invalid @enderror">
                  @error('name')
