...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">View Brand</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.brand.add') }}" class="btn btn-outline-success btn-sm mb-2">Add new</a>
          </div>
            ...
            <table id="brand_data_table" class="table w-100 thead-dark table-striped no-footer">
              ...
              <tbody>
                ...
                @foreach($brands as $value)
                  <tr class="gradeX">
                    <td width="30">{{ ++$id }}</td>
                    <td><img src="{{ asset($value->image) }}" alt="{{ $value->slug }}" height="100px"></td>
                    <td>{{ $value->name }}</td>
                    <td width="30">
                      <a href="{{ route('admin.brand.edit', $value->slug) }}" class="btn btn-outline-info btn-sm m-0 p-1 mr-1" style="min-width: 0px;">
