...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">VIew Inactive Customer</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.view_customer') }}" class="btn btn-outline-success btn-sm mb-2">View all</a>
          </div>
          ...
          <div class="table-responsive">
            <table id="brand_data_table" class="table w-100 thead-dark table-striped no-footer">
              ...
              <tbody>
              @foreach($inactive_customers as $key => $value)
                <tr class="gradeX">
                  <td width="30">{{ ++$key }}</td>
