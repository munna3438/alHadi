      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.policy.view') }}" class="btn btn-outline-success btn-sm mb-2">View Policy</a>
          </div>
          <form action="{{ route('admin.policy.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="title_en" placeholder="Enter  title [EN]" value="{{old('title_en', $policy-> title_en)}}" required name="title_en"  class="form-control @error('title_en') is-invalid @enderror">
              @error('title_en')
            ...
            <div class="form-group">
              ...
              <textarea id="summernote" name="description_en" required>{{ $policy-> description_en }}</textarea>
