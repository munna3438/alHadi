      ...
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          ...
          @if(session()->has('status'))
            {!! session()->get('status') !!}
          @endif
          <form action="{{ route('admin.category.edit', $category->slug ) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
              <label for="category_name">Name</label>
              <input type="text" id="category_name" placeholder="Enter a category name" name="name" value="{{ $category->name }}" class="form-control @error('name') is-invalid @enderror">
              @error('name')
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-4 col-lg-4 col-xl-4 text-center">
                  <img src="{{ asset($category->image) }}" alt="" class="border-dark">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="file" id="category_image" placeholder="Choose a brand Image" name="category_image" class="form-control @error('category_image') is-invalid @enderror">
