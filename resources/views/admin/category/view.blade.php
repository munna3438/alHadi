...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">View Category</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <div class="form-group text-right">
            <a href="{{ route('admin.category.add') }}" class="btn btn-outline-success btn-sm mb-2">Add new</a>
          </div>
            ...
            <table id="category_data_table" class="table w-100 thead-dark table-striped no-footer">
              ...
              <tbody>
                ...
                @foreach($categories as $value)
                  <tr class="gradeX">
                    <td width="30">{{ ++$id }}</td>
                    <td><img src="{{ asset($value->image) }}" alt="{{ $value->name }}" width="100px" height="100px"></td>
                    <td>{{ $value->name }}</td>
                    <td width="30">
                      <div class="d-flex">
                        <a href="{{ route('admin.category.edit', $value->slug) }}" class="btn btn-outline-info btn-sm m-0 p-1 mr-1" style="min-width: 0px;">
