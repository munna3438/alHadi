...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <h1 class="db-header-title">Add Banner</h1>
    </div>
    <div class="col-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          ...
          <form action="{{ route('admin.banner.add') }}" method="post" enctype="multipart/form-data">
            ...
            {{--<div class="form-group">--}}
              {{--<div class="row">--}}
                {{--<div class="col-12">--}}
                  {{--<label for="banner_title">Title <span class="text-danger">*</span></label>--}}
                  {{--<input type="text" id="banner_title" required value="{{old('title')}}" placeholder="Enter a banner title" name="title" class="form-control @error('title') is-invalid @enderror">--}}
                  {{--@error('title')--}}
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-12">
                  <img src="" id="banner_image_view" style="max-height: 300px;" alt="">
                </div>
                <div class="col-12">
                  ...
                  <input type="file" id="banner_image" cols="30" rows="5" value="{{old('banner_image')}}" placeholder="Enter product banner_image" name="banner_image" class="form-control @error('banner_image') is-invalid @enderror" required >
                  @error('banner_image')
